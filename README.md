...
* Docker
    ...
    docker run -it -v /dinastycoin/chain:/root/.dinastycoin -v /dinastycoin/wallet:/wallet -p 38080:38080 dinastycoin
    
    # or in background
    docker run -it -d -v /dinastycoin/chain:/root/.dinastycoin -v /dinastycoin/wallet:/wallet -p 38080:38080 dinastycoin
    ```
...
```bash
sudo iptables -I OUTPUT 2 -p tcp -d 127.0.0.1 -m tcp --dport 38081 -j ACCEPT
