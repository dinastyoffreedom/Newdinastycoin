...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/dinastycoin-project/dinastycoin', help='Specify the URL of the repository. Default is %(default)s')
